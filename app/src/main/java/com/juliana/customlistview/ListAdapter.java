...
public class ListAdapter extends BaseAdapter {
        ...
        int[]IdImagen;
        // El layoutInflater sirve para poner datos (inflar) en una interfaz grafica
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        fotoPerfil.setImageResource(IdImagen[i]);//poner las diferentes imagenes, en diferentes posiciones
